...
const days = ref<IWeekDay[]>([
  ...
  { id: 3, name: 'Mièrcoles', selected: false },
...
<div class=" items-center gap-4 rounded-xl bg-white p-6 shadow-lg outline outline-black/5 justify-center m-4">
...
<div class="flex flex-row gap-4 p-4 max-w-full ">
